  ...
  const filterFields: FilterField[] = [
    {
      ...
      type: "text",
      placeholder: t("drug.form.placeholder.name"),
      width: 200,
    },
    {
      name: "min_price",
      label: t("drug.filter.minPrice"),
      type: "number",
      placeholder: t("drug.filter.minPricePlaceholder"),
      min: 0,
      width: 150,
    },
    {
      name: "max_price",
      label: t("drug.filter.maxPrice"),
      type: "number",
      placeholder: t("drug.filter.maxPricePlaceholder"),
      min: 0,
      width: 150,
    },
    {
      name: "min_stock",
      label: t("drug.filter.minStock"),
      type: "number",
      placeholder: t("drug.filter.minStockPlaceholder"),
      min: 0,
      width: 150,
    },
    {
      name: "max_stock",
      label: t("drug.filter.maxStock"),
      type: "number",
      placeholder: t("drug.filter.maxStockPlaceholder"),
      min: 0,
      width: 150,
    },
  ];
